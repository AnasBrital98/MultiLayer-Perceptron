...
NN = NeuralNetwork(x_train, y_train, layers=(2,8,32,32,8,3), learning_rate=0.1, n_iterations=1000)
NN.train()
NN.displayResult()



y_hat  = NN.prediction(x_test.T)
...
print(f"Number of samples that The Model Failed to classify in The Test Data is : {len(y_hat)-count}")
